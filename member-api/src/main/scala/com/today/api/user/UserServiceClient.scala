...
####  输出
    1. user_response.FindUserByPageResponse
         ...
         **/
            ...
            def findUserByPage(request:com.today.api.user.request.FindUserByPageRequest ) : com.today.api.user.response.FindUserByPageResponse = {

            initContext("findUserByPage");

            try {
              val response = sendBase(findUserByPage_args(request), new FindUserByPage_argsSerializer(), new FindUserByPage_resultSerializer())
